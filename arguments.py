...
parser = argparse.ArgumentParser(description='Read XML file and update fias database')
...
parser.add_argument('-u', help='user name used to authenticate in db connection')
